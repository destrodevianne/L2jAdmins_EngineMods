...
public class PlayerHolder
{
	...
	private LocationHolder _posToFarm = null;
	...
	public void setPosToFarm(String pos)
	{
		...
		_posToFarm = new LocationHolder(x, y, z);
	}
	...
	public LocationHolder getPosToFarm()
	{
		return _posToFarm;
	}
	...
	private Map<StatsType, Integer> _statsCustom = new HashMap<>();
	{
		_statsCustom.put(StatsType.STAT_STR, 0);
		_statsCustom.put(StatsType.STAT_CON, 0);
		_statsCustom.put(StatsType.STAT_DEX, 0);
		_statsCustom.put(StatsType.STAT_INT, 0);
		_statsCustom.put(StatsType.STAT_WIT, 0);
		_statsCustom.put(StatsType.STAT_MEN, 0);
	}
	
	public int getCustomStat(StatsType stat)
	{
		return _statsCustom.get(stat);
	}
	
	public void addCustomStat(StatsType stat, int value)
	{

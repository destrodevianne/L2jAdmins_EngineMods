	...
	public boolean onInteract(L2PcInstance player, L2Character npc)
	{
		...
		else
		{
			...
			if (_player == null)
			{
				...
				hb.append("<td><button value=\"Vote\" action=\"bypass -h Engine " + NPC + " ", NpcVoteRewardNetwork.class.getSimpleName(), " vote\" width=216 height=32 back=", L2UI_CH3.refinegrade3_21, " fore=", L2UI_CH3.refinegrade3_21, "></td>");
				hb.append("<td align=center>", Html.newImage(L2UI.bbs_folder, 32, 32), "</td>");
				hb.append("</tr>");
				hb.append("</table>");
			}
